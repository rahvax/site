...
## Minha configuração
A minha configuração é simples e utiliza integração das teclas e comandos do VIM dentro do Emacs, focada mais em programação e anotação de conteúdos. Há muitas partes que copiei da documentação ou de meu amigo que é um usuário mais experiente; como ainda estou aprendendo ELisp e a configurar o Emacs (a curva de aprendizado é enorme), pode conter algumas coisas bem discutíveis nela.
