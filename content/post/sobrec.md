...
# Minha opnião sobre o C
Para começar, devo dizer que não sou profissional em desenvolvimento e não tenho tanta experiência. Sou apenas um programador por hobby, e isso reflete na minha visão com a linguagem. Em geral, C foi uma linguagem que me entregou boas experiências e eu consegui trabalhar em praticamente tudo que eu precisei dentro da minha área ou em projetos pessoais.

Apenas em áreas como `Inteligência Artificial` houve problemas maiores com a linguagem, já que se torna uma dor de cabeça utilizar C aqui. Tanto documentações, bibliotecas já feitas e exemplos são para linguagens como `Python`, e C se torna um desafio desnecessário para mim dentro dessas áreas em que ele não brilhou — mas foram raras, devo admitir. Também considero que a linguagem C me ensinou muito sobre programação, e recomendo para qualquer um que esteja interessado em aprender a linguagem: não escute a comunidade de tecnologia e suas discussões sem sentido sobre linguagens, teste com calma e paciência você mesmo e tenha suas próprias conclusões.